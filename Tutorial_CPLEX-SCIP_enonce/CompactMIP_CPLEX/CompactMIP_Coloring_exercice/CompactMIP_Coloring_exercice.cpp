...
// MIN sum_{l = 1 to K} w_l
// sum{l= 1 to K} x_u_l = 1 for every node u in V
// x_u_l + x_v_l <= w_l for every edge e = uv in E and  1<= l <= K
// x_u_l in {0,1} for every node u in V and 1 <= l <= K
// x_v_l in {0,1} for every node v in V and 1 <= l <= K
// w_l in {0,1}
